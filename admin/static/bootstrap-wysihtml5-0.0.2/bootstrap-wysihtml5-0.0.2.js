	...
	var templates = {
		"font-styles": "<li class='dropdown'>" +
							"<a class='btn dropdown-toggle' data-toggle='dropdown' href='#'>" +
								"<i class='icon-font'></i>&nbsp;<span class='current-font'>Formatvorlage</span>&nbsp;<b class='caret'></b>" +
							"</a>" +
						    "<ul class='dropdown-menu'>" +
						      	"<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='div'>Normaler Text</a></li>" +
		...
		"lists": 	"<li>" 
						+ "<div class='btn-group'>" 
						    ...
						    + "<a class='btn' data-wysihtml5-command='Outdent' title='Ausrücken'><i class='icon-indent-right'></i></a>"
						    + "<a class='btn' data-wysihtml5-command='Indent' title='Einrücken'><i class='icon-indent-left'></i></a>"
						+ "</div>" 
					+ "</li>",
		...
		"link": 	"<li>" 
						...
						+ "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>"
							...
							+ "<div class='modal-footer'>"
							  ...
							  + "<a href='#' class='btn btn-primary' data-dismiss='modal'>Einfügen</a>"
							+ "</div>"
						+ "</div>"
